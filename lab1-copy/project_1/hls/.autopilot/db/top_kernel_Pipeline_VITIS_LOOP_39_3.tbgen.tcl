set moduleName top_kernel_Pipeline_VITIS_LOOP_39_3
set isTopModule 0
...
set cdfgNum 8
set C_modelName {top_kernel_Pipeline_VITIS_LOOP_39_3}
...
set C_modelArgMapList {[ 
	{ "Name" : "zext_ln41", "interface" : "wire", "bitwidth" : 14, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln41 sc_in sc_lv 14 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln41", "direction": "in", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "zext_ln41", "role": "default" }} , 
...
set Spec2ImplPortList { 
	zext_ln41 { ap_none {  { zext_ln41 in_data 0 14 } } }
