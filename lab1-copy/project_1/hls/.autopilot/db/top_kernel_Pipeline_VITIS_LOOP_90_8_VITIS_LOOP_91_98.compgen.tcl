...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler top_kernel_sparsemux_115_6_24_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {compactencoding_dontcare}
}
...
eval "cg_default_interface_gen_dc { \
    id 2485 \
    name col_sum_1_load_1_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_col_sum_1_load_1_out \
    op interface \
    ports { col_sum_1_load_1_out { O 24 vector } col_sum_1_load_1_out_ap_vld { O 1 bit } } \
} "
}
