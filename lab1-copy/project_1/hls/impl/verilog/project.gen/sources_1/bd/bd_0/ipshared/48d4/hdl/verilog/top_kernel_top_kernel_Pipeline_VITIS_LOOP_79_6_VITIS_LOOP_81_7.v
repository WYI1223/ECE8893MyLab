...
module top_kernel_top_kernel_Pipeline_VITIS_LOOP_79_6_VITIS_LOOP_81_7 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln79_fu_796_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire    ap_block_pp0_stage0_11001;
wire   [63:0] zext_ln84_2_fu_864_p1;
reg   [63:0] zext_ln84_2_reg_1402;
reg   [63:0] zext_ln84_2_reg_1402_pp0_iter1_reg;
wire   [23:0] tmp_1_fu_873_p131;
reg  signed [23:0] tmp_1_reg_1412;
wire   [23:0] select_ln84_3_fu_1369_p3;
reg   [23:0] select_ln84_3_reg_1417;
wire    ap_block_pp0_stage0;
reg   [6:0] j_fu_352;
wire   [6:0] add_ln81_fu_1137_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_j_load;
reg   [8:0] i_fu_356;
wire   [8:0] select_ln79_1_fu_834_p3;
reg   [8:0] ap_sig_allocacmp_i_load;
reg   [14:0] indvar_flatten_fu_360;
wire   [14:0] add_ln79_1_fu_802_p2;
reg   [14:0] ap_sig_allocacmp_indvar_flatten_load;
reg    tmp_ce0_local;
reg    C_we0_local;
reg    C_ce0_local;
wire   [0:0] icmp_ln81_fu_820_p2;
wire   [8:0] add_ln79_fu_814_p2;
wire   [7:0] trunc_ln84_fu_842_p1;
wire   [6:0] select_ln79_fu_826_p3;
wire   [13:0] tmp_s_fu_846_p3;
wire   [13:0] zext_ln84_1_fu_854_p1;
wire   [13:0] add_ln84_1_fu_858_p2;
wire   [23:0] tmp_1_fu_873_p129;
wire   [5:0] tmp_1_fu_873_p130;
wire   [47:0] mul_ln84_fu_774_p2;
wire   [0:0] tmp_2_fu_1185_p3;
wire   [23:0] trunc_ln3_fu_1175_p4;
wire   [23:0] zext_ln84_fu_1201_p1;
wire   [23:0] add_ln84_fu_1205_p2;
wire   [0:0] tmp_4_fu_1211_p3;
wire   [0:0] tmp_3_fu_1193_p3;
wire   [0:0] xor_ln84_fu_1219_p2;
wire   [6:0] tmp_6_fu_1239_p3;
wire   [7:0] tmp_7_fu_1253_p3;
wire   [0:0] and_ln84_fu_1225_p2;
wire   [0:0] icmp_ln84_1_fu_1261_p2;
wire   [0:0] icmp_ln84_2_fu_1267_p2;
wire   [0:0] tmp_5_fu_1231_p3;
wire   [0:0] icmp_ln84_fu_1247_p2;
wire   [0:0] xor_ln84_1_fu_1281_p2;
wire   [0:0] and_ln84_1_fu_1287_p2;
wire   [0:0] select_ln84_fu_1273_p3;
wire   [0:0] xor_ln84_2_fu_1307_p2;
wire   [0:0] tmp_1_1_fu_1167_p3;
wire   [0:0] or_ln84_fu_1313_p2;
wire   [0:0] xor_ln84_3_fu_1319_p2;
wire   [0:0] select_ln84_1_fu_1293_p3;
wire   [0:0] and_ln84_2_fu_1301_p2;
wire   [0:0] and_ln84_4_fu_1331_p2;
wire   [0:0] or_ln84_2_fu_1337_p2;
wire   [0:0] xor_ln84_4_fu_1343_p2;
wire   [0:0] and_ln84_3_fu_1325_p2;
wire   [0:0] and_ln84_5_fu_1349_p2;
wire   [0:0] or_ln84_1_fu_1363_p2;
wire   [23:0] select_ln84_2_fu_1355_p3;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln79_fu_796_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        zext_ln84_2_reg_1402[13 : 0] <= zext_ln84_2_fu_864_p1[13 : 0];
        zext_ln84_2_reg_1402_pp0_iter1_reg[13 : 0] <= zext_ln84_2_reg_1402[13 : 0];
    end
end
...
always @ (*) begin
    if (((icmp_ln79_fu_796_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign C_address0 = zext_ln84_2_reg_1402_pp0_iter1_reg;

assign C_ce0 = C_ce0_local;

assign C_d0 = select_ln84_3_reg_1417;

assign C_we0 = C_we0_local;

assign add_ln79_1_fu_802_p2 = (ap_sig_allocacmp_indvar_flatten_load + 15'd1);

assign add_ln79_fu_814_p2 = (ap_sig_allocacmp_i_load + 9'd1);

assign add_ln81_fu_1137_p2 = (select_ln79_fu_826_p3 + 7'd1);

assign add_ln84_1_fu_858_p2 = (tmp_s_fu_846_p3 + zext_ln84_1_fu_854_p1);

assign add_ln84_fu_1205_p2 = (trunc_ln3_fu_1175_p4 + zext_ln84_fu_1201_p1);

assign and_ln84_1_fu_1287_p2 = (xor_ln84_1_fu_1281_p2 & icmp_ln84_fu_1247_p2);

assign and_ln84_2_fu_1301_p2 = (icmp_ln84_1_fu_1261_p2 & and_ln84_fu_1225_p2);

assign and_ln84_3_fu_1325_p2 = (xor_ln84_3_fu_1319_p2 & or_ln84_fu_1313_p2);

assign and_ln84_4_fu_1331_p2 = (tmp_4_fu_1211_p3 & select_ln84_1_fu_1293_p3);

assign and_ln84_5_fu_1349_p2 = (xor_ln84_4_fu_1343_p2 & tmp_1_1_fu_1167_p3);

assign and_ln84_fu_1225_p2 = (xor_ln84_fu_1219_p2 & tmp_3_fu_1193_p3);
...
assign icmp_ln79_fu_796_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 15'd16384) ? 1'b1 : 1'b0);

assign icmp_ln81_fu_820_p2 = ((ap_sig_allocacmp_j_load == 7'd64) ? 1'b1 : 1'b0);

assign icmp_ln84_1_fu_1261_p2 = ((tmp_7_fu_1253_p3 == 8'd255) ? 1'b1 : 1'b0);

assign icmp_ln84_2_fu_1267_p2 = ((tmp_7_fu_1253_p3 == 8'd0) ? 1'b1 : 1'b0);

assign icmp_ln84_fu_1247_p2 = ((tmp_6_fu_1239_p3 == 7'd127) ? 1'b1 : 1'b0);

assign or_ln84_1_fu_1363_p2 = (and_ln84_5_fu_1349_p2 | and_ln84_3_fu_1325_p2);

assign or_ln84_2_fu_1337_p2 = (and_ln84_4_fu_1331_p2 | and_ln84_2_fu_1301_p2);

assign or_ln84_fu_1313_p2 = (xor_ln84_2_fu_1307_p2 | tmp_4_fu_1211_p3);

assign select_ln79_1_fu_834_p3 = ((icmp_ln81_fu_820_p2[0:0] == 1'b1) ? add_ln79_fu_814_p2 : ap_sig_allocacmp_i_load);

assign select_ln79_fu_826_p3 = ((icmp_ln81_fu_820_p2[0:0] == 1'b1) ? 7'd0 : ap_sig_allocacmp_j_load);

assign select_ln84_1_fu_1293_p3 = ((and_ln84_fu_1225_p2[0:0] == 1'b1) ? and_ln84_1_fu_1287_p2 : icmp_ln84_1_fu_1261_p2);

assign select_ln84_2_fu_1355_p3 = ((and_ln84_3_fu_1325_p2[0:0] == 1'b1) ? 24'd8388607 : 24'd8388608);

assign select_ln84_3_fu_1369_p3 = ((or_ln84_1_fu_1363_p2[0:0] == 1'b1) ? select_ln84_2_fu_1355_p3 : add_ln84_fu_1205_p2);

assign select_ln84_fu_1273_p3 = ((and_ln84_fu_1225_p2[0:0] == 1'b1) ? icmp_ln84_1_fu_1261_p2 : icmp_ln84_2_fu_1267_p2);

assign tmp_1_1_fu_1167_p3 = mul_ln84_fu_774_p2[32'd47];

assign tmp_1_fu_873_p129 = 'bx;

assign tmp_1_fu_873_p130 = select_ln79_fu_826_p3[5:0];

assign tmp_2_fu_1185_p3 = mul_ln84_fu_774_p2[32'd15];

assign tmp_3_fu_1193_p3 = mul_ln84_fu_774_p2[32'd39];

assign tmp_4_fu_1211_p3 = add_ln84_fu_1205_p2[32'd23];

assign tmp_5_fu_1231_p3 = mul_ln84_fu_774_p2[32'd40];

assign tmp_6_fu_1239_p3 = {{mul_ln84_fu_774_p2[47:41]}};

assign tmp_7_fu_1253_p3 = {{mul_ln84_fu_774_p2[47:40]}};

assign tmp_address0 = zext_ln84_2_fu_864_p1;

assign tmp_ce0 = tmp_ce0_local;

assign tmp_s_fu_846_p3 = {{trunc_ln84_fu_842_p1}, {6'd0}};

assign trunc_ln3_fu_1175_p4 = {{mul_ln84_fu_774_p2[39:16]}};

assign trunc_ln84_fu_842_p1 = select_ln79_1_fu_834_p3[7:0];

assign xor_ln84_1_fu_1281_p2 = (tmp_5_fu_1231_p3 ^ 1'd1);

assign xor_ln84_2_fu_1307_p2 = (select_ln84_fu_1273_p3 ^ 1'd1);

assign xor_ln84_3_fu_1319_p2 = (tmp_1_1_fu_1167_p3 ^ 1'd1);

assign xor_ln84_4_fu_1343_p2 = (or_ln84_2_fu_1337_p2 ^ 1'd1);

assign xor_ln84_fu_1219_p2 = (tmp_4_fu_1211_p3 ^ 1'd1);

assign zext_ln84_1_fu_854_p1 = select_ln79_fu_826_p3;

assign zext_ln84_2_fu_864_p1 = add_ln84_1_fu_858_p2;

assign zext_ln84_fu_1201_p1 = tmp_2_fu_1185_p3;

always @ (posedge ap_clk) begin
    zext_ln84_2_reg_1402[63:14] <= 50'b00000000000000000000000000000000000000000000000000;
    zext_ln84_2_reg_1402_pp0_iter1_reg[63:14] <= 50'b00000000000000000000000000000000000000000000000000;
end

endmodule //top_kernel_top_kernel_Pipeline_VITIS_LOOP_79_6_VITIS_LOOP_81_7
