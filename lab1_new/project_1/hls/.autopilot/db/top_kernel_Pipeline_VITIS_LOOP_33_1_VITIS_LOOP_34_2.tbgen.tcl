set moduleName top_kernel_Pipeline_VITIS_LOOP_33_1_VITIS_LOOP_34_2
set isTopModule 0
...
set cdfgNum 9
set C_modelName {top_kernel_Pipeline_VITIS_LOOP_33_1_VITIS_LOOP_34_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict A_1 { MEM_WIDTH 24 MEM_SIZE 49152 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ A int 32 regular {axi_master 0}  }
	{ sext_ln33 int 62 regular  }
	{ A_1 int 24 regular {array 16384 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ A_1_address0 sc_out sc_lv 14 signal 2 } 
...
set Spec2ImplPortList { 
	...
	A_1 { ap_memory {  { A_1_address0 mem_address 1 14 }  { A_1_ce0 mem_ce 1 1 }  { A_1_we0 mem_we 1 1 }  { A_1_d0 mem_din 1 24 } } }
}
