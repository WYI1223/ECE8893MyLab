...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename row_buf_3 \
    op interface \
    ports { row_buf_3_address0 { O 4 vector } row_buf_3_ce0 { O 1 bit } row_buf_3_q0 { I 24 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename row_buf_2 \
    op interface \
    ports { row_buf_2_address0 { O 4 vector } row_buf_2_ce0 { O 1 bit } row_buf_2_q0 { I 24 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename row_buf_1 \
    op interface \
    ports { row_buf_1_address0 { O 4 vector } row_buf_1_ce0 { O 1 bit } row_buf_1_q0 { I 24 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename row_buf \
    op interface \
    ports { row_buf_address0 { O 4 vector } row_buf_ce0 { O 1 bit } row_buf_q0 { I 24 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_conv_i347 \
    op interface \
    ports { conv_i347 { I 24 vector } } \
} "
}
