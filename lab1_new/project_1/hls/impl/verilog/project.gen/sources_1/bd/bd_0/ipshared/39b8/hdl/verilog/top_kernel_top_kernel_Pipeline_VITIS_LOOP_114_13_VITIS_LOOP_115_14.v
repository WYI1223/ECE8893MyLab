...
module top_kernel_top_kernel_Pipeline_VITIS_LOOP_114_13_VITIS_LOOP_115_14 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   C_1_ce0;
input  [23:0] C_1_q0;
output  [12:0] C_1_15_address0;
output   C_1_15_ce0;
input  [23:0] C_1_15_q0;
...
wire   [0:0] trunc_ln115_1_fu_192_p1;
reg   [0:0] trunc_ln115_1_reg_288;
wire   [23:0] select_ln117_fu_241_p3;
reg   [23:0] select_ln117_reg_303;
wire   [63:0] zext_ln117_1_fu_214_p1;
wire    ap_block_pp0_stage0;
wire    ap_block_pp0_stage0_01001_grp1;
reg   [6:0] j_fu_68;
wire   [6:0] add_ln115_fu_220_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_j_load;
reg   [8:0] i_fu_72;
wire   [8:0] select_ln114_1_fu_180_p3;
reg   [8:0] ap_sig_allocacmp_i_load;
reg   [14:0] indvar_flatten13_fu_76;
wire   [14:0] add_ln114_1_fu_148_p2;
reg   [14:0] ap_sig_allocacmp_indvar_flatten13_load;
reg    C_1_ce0_local;
reg    C_1_15_ce0_local;
wire   [0:0] icmp_ln115_fu_166_p2;
wire   [8:0] add_ln114_fu_160_p2;
wire   [6:0] select_ln114_fu_172_p3;
wire   [7:0] trunc_ln115_fu_188_p1;
wire   [4:0] lshr_ln3_fu_196_p4;
wire   [12:0] tmp_s_fu_206_p3;
reg    ap_done_reg;
...
#0 j_fu_68 = 7'd0;
#0 i_fu_72 = 9'd0;
#0 indvar_flatten13_fu_76 = 15'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln114_fu_142_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        C_1_15_ce0_local = 1'b1;
    end else begin
        C_1_15_ce0_local = 1'b0;
    end
end
...
always @ (*) begin
    if (((icmp_ln114_fu_142_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign C_1_15_address0 = zext_ln117_1_fu_214_p1;

assign C_1_15_ce0 = C_1_15_ce0_local;

assign C_1_address0 = zext_ln117_1_fu_214_p1;

assign C_1_ce0 = C_1_ce0_local;

assign add_ln114_1_fu_148_p2 = (ap_sig_allocacmp_indvar_flatten13_load + 15'd1);

assign add_ln114_fu_160_p2 = (ap_sig_allocacmp_i_load + 9'd1);

assign add_ln115_fu_220_p2 = (select_ln114_fu_172_p3 + 7'd1);
...
assign icmp_ln114_fu_142_p2 = ((ap_sig_allocacmp_indvar_flatten13_load == 15'd16384) ? 1'b1 : 1'b0);

assign icmp_ln115_fu_166_p2 = ((ap_sig_allocacmp_j_load == 7'd64) ? 1'b1 : 1'b0);

assign lshr_ln3_fu_196_p4 = {{select_ln114_fu_172_p3[5:1]}};
...
assign m_axi_C_0_WDATA = select_ln117_reg_303;
...
assign select_ln114_1_fu_180_p3 = ((icmp_ln115_fu_166_p2[0:0] == 1'b1) ? add_ln114_fu_160_p2 : ap_sig_allocacmp_i_load);

assign select_ln114_fu_172_p3 = ((icmp_ln115_fu_166_p2[0:0] == 1'b1) ? 7'd0 : ap_sig_allocacmp_j_load);

assign select_ln117_fu_241_p3 = ((trunc_ln115_1_reg_288[0:0] == 1'b1) ? C_1_15_q0 : C_1_q0);

assign tmp_s_fu_206_p3 = {{trunc_ln115_fu_188_p1}, {lshr_ln3_fu_196_p4}};

assign trunc_ln115_1_fu_192_p1 = select_ln114_fu_172_p3[0:0];

assign trunc_ln115_fu_188_p1 = select_ln114_1_fu_180_p3[7:0];

assign zext_ln117_1_fu_214_p1 = tmp_s_fu_206_p3;

endmodule //top_kernel_top_kernel_Pipeline_VITIS_LOOP_114_13_VITIS_LOOP_115_14
