...
set C_modelArgList {
	...
	{ C_r int 64 regular {axi_slave 0}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "A", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "A_r","offset": { "type": "dynamic","port_name": "A_r","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "C_r", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":28}, "offset_end" : {"in":39}} ]}
...
set ArgLastReadFirstWriteLatency {
	top_kernel {
		...
		C {Type O LastRead 14 FirstWrite 3}
		A_r {Type I LastRead 0 FirstWrite -1}
		C_r {Type I LastRead 0 FirstWrite -1}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "48160", "Max" : "48160"}
	, {"Name" : "Interval", "Min" : "48161", "Max" : "48161"}
]}
