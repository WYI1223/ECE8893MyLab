                    ...
                    fork
                        ...
                        begin
                            ...
                            for(int i=0; i<1; i++) begin
                                ...
                                logic[63:0] data64bit_C_r[$];
                                logic[32-1:0] databusbit_C_r[$];
                                ...
                                data64bit_C_r.delete(); databusbit_C_r.delete();
                                axi_master_wr_control_seq.StableAxiliteNoUpdate=0;
                                for(int j=0; j < (64+32-1)/32; j++) begin
                                    data64bit_C_r.push_back( ((refm.mem_blk_pages_C.maxi_bundlevar_offset["C_r"]+refm.mem_blk_pages_C.page_ofst[refm.mem_blk_pages_C.rd_page_idx])>>(j*32)) & (2**32-1) );
                                end
                                foreach(data64bit_C_r[s]) databusbit_C_r[s]=data64bit_C_r[s][32-1:0];
                                axi_master_wr_control_seq.StableAxiliteNoUpdate=1;
                                axi_master_wr_control_seq.datamerge_inavg(databusbit_C_r, 0, 28, 1);
