...
`define TV_IN_OFFSET_C_r "../tv/cdatafile/c.top_kernel.autotvin_C_r.dat"
`define TV_IN_A_r "../tv/cdatafile/c.top_kernel.autotvin_A_r.dat"
`define TV_OUT_A_r ""
`define TV_IN_C_r "../tv/cdatafile/c.top_kernel.autotvin_C_r.dat"
`define TV_OUT_C_r ""
...
misc_if.dut2tb_ap_done = 0;
        ...
        mem_blk_pages_C.maxi_bundlevar_fpath["C_r"]=`TV_IN_OFFSET_C_r;
