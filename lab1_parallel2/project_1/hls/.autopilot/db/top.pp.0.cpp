...
# 43 "/tools/software/xilinx/2025.1.1/Vitis/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/cstring" 2 3
# 71 "/tools/software/xilinx/2025.1.1/Vitis/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/cstring" 3
namespace std __attribute__ ((__visibility__ ("default")))
{
  ...
  using ::strrchr;
  using ::strstr;
# 121 "/tools/software/xilinx/2025.1.1/Vitis/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/cstring" 3
}
# 3 "top.cpp" 2
...
#line 22 "/nethome/wsun377/ece8893/FPGA_ECE8893_1/2026_Spring/lab1_parallel2/script.tcl"
...
#pragma HLS PIPELINE II=1
 col_sum[j] = (data_t)0.0;
    ...
    VITIS_LOOP_42_2: for (int i = 0; i < 256; i++) {
        ...
        VITIS_LOOP_44_3: for (int j = 0; j < 64; j++) {
#pragma HLS PIPELINE II=1
 data_t a = A_DRAM[i][j];
            A[i][j] = a;
            row_sum += a;
    ...
    VITIS_LOOP_58_4: for (int idx = 0; idx < TOT_N; idx++) {
#pragma HLS PIPELINE II=1
 int i = idx / BLKS_N;
        int b = idx - i * BLKS_N;
        int jb = b * UF_NORM;
...
#pragma HLS DEPENDENCE variable=col_sum inter false
 VITIS_LOOP_67_5: for (int k = 0; k < UF_NORM; k++) {
#pragma HLS UNROLL
 int j = jb + k;
    ...
    VITIS_LOOP_77_6: for (int jb = 0; jb < 64; jb += UF_NORM) {
#pragma HLS PIPELINE II=1
 VITIS_LOOP_79_7: for (int k = 0; k < UF_NORM; k++) {
#pragma HLS UNROLL
 int j = jb + k;
...
#pragma HLS ARRAY_PARTITION variable=rowC cyclic factor=UF_NORM dim=1
 ...
 VITIS_LOOP_92_9: for (int j = 0; j < 64; j++) {
#pragma HLS PIPELINE II=1
