...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename rowC_7 \
    op interface \
    ports { rowC_7_address0 { O 3 vector } rowC_7_ce0 { O 1 bit } rowC_7_we0 { O 1 bit } rowC_7_d0 { O 24 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'rowC_7'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename rowC_6 \
    op interface \
    ports { rowC_6_address0 { O 3 vector } rowC_6_ce0 { O 1 bit } rowC_6_we0 { O 1 bit } rowC_6_d0 { O 24 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'rowC_6'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename rowC_5 \
    op interface \
    ports { rowC_5_address0 { O 3 vector } rowC_5_ce0 { O 1 bit } rowC_5_we0 { O 1 bit } rowC_5_d0 { O 24 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'rowC_5'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename rowC_4 \
    op interface \
    ports { rowC_4_address0 { O 3 vector } rowC_4_ce0 { O 1 bit } rowC_4_we0 { O 1 bit } rowC_4_d0 { O 24 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'rowC_4'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename rowC_3 \
    op interface \
    ports { rowC_3_address0 { O 3 vector } rowC_3_ce0 { O 1 bit } rowC_3_we0 { O 1 bit } rowC_3_d0 { O 24 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'rowC_3'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename rowC_2 \
    op interface \
    ports { rowC_2_address0 { O 3 vector } rowC_2_ce0 { O 1 bit } rowC_2_we0 { O 1 bit } rowC_2_d0 { O 24 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'rowC_2'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename rowC_1 \
    op interface \
    ports { rowC_1_address0 { O 3 vector } rowC_1_ce0 { O 1 bit } rowC_1_we0 { O 1 bit } rowC_1_d0 { O 24 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'rowC_1'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename rowC \
    op interface \
    ports { rowC_address0 { O 3 vector } rowC_ce0 { O 1 bit } rowC_we0 { O 1 bit } rowC_d0 { O 24 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'rowC'"
}
}
