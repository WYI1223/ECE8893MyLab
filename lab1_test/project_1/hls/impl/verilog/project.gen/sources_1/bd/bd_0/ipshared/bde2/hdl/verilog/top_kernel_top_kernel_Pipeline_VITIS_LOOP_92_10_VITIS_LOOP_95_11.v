...
module top_kernel_top_kernel_Pipeline_VITIS_LOOP_92_10_VITIS_LOOP_95_11 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_idle_pp0;
reg   [0:0] icmp_ln105_reg_1107;
reg   [0:0] icmp_ln105_reg_1107_pp0_iter5_reg;
reg    ap_block_state7_io_grp1;
reg    ap_block_pp0_stage0_subdone;
wire   [0:0] icmp_ln92_fu_460_p2;
...
wire   [0:0] icmp_ln95_fu_484_p2;
reg   [0:0] icmp_ln95_reg_1009;
wire   [2:0] trunc_ln95_fu_518_p1;
reg   [2:0] trunc_ln95_reg_1015;
reg   [0:0] tmp_reg_1061;
wire   [0:0] icmp_ln105_fu_574_p2;
reg   [0:0] icmp_ln105_reg_1107_pp0_iter1_reg;
reg   [0:0] icmp_ln105_reg_1107_pp0_iter2_reg;
reg   [0:0] icmp_ln105_reg_1107_pp0_iter3_reg;
reg   [0:0] icmp_ln105_reg_1107_pp0_iter4_reg;
wire   [23:0] select_ln108_3_fu_947_p3;
reg   [23:0] select_ln108_3_reg_1121;
wire   [63:0] zext_ln101_1_fu_554_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln95_fu_532_p1;
wire    ap_block_pp0_stage0_01001_grp1;
reg   [23:0] empty_fu_186;
wire   [23:0] t_cur_1_fu_699_p3;
wire    ap_loop_init;
reg   [16:0] empty_28_fu_190;
wire   [16:0] s_cur_1_fu_706_p3;
reg   [6:0] j_fu_194;
wire   [6:0] add_ln95_fu_580_p2;
reg   [6:0] ap_sig_allocacmp_j_load;
reg   [8:0] i_fu_198;
wire   [8:0] select_ln92_3_fu_498_p3;
reg   [8:0] ap_sig_allocacmp_i_load;
reg   [14:0] indvar_flatten15_fu_202;
wire   [14:0] add_ln92_1_fu_466_p2;
...
wire   [8:0] add_ln92_fu_478_p2;
wire   [7:0] trunc_ln101_fu_506_p1;
wire   [6:0] select_ln92_fu_490_p3;
wire   [3:0] lshr_ln3_fu_522_p4;
wire   [10:0] tmp_s_fu_510_p3;
wire   [10:0] zext_ln101_fu_544_p1;
wire   [10:0] add_ln101_fu_548_p2;
wire   [23:0] t_cur_fu_621_p17;
wire   [16:0] s_cur_fu_660_p17;
wire   [23:0] t_cur_fu_621_p19;
wire   [16:0] s_cur_fu_660_p19;
wire  signed [23:0] select_ln92_2_fu_614_p3;
wire  signed [16:0] select_ln92_1_fu_607_p3;
wire  signed [40:0] grp_fu_721_p2;
wire  signed [47:0] sext_ln107_fu_737_p1;
wire   [0:0] tmp_2_fu_759_p3;
wire   [23:0] trunc_ln4_fu_749_p4;
wire   [23:0] zext_ln108_fu_775_p1;
wire   [23:0] add_ln108_fu_779_p2;
wire   [0:0] tmp_4_fu_785_p3;
wire   [0:0] tmp_3_fu_767_p3;
wire   [0:0] xor_ln108_fu_793_p2;
wire   [1:0] tmp_6_fu_813_p4;
wire   [2:0] tmp_7_fu_829_p4;
wire   [0:0] and_ln108_fu_799_p2;
wire   [0:0] icmp_ln108_1_fu_839_p2;
wire   [0:0] icmp_ln108_2_fu_845_p2;
wire   [0:0] tmp_5_fu_805_p3;
wire   [0:0] icmp_ln108_fu_823_p2;
wire   [0:0] xor_ln108_1_fu_859_p2;
wire   [0:0] and_ln108_1_fu_865_p2;
wire   [0:0] select_ln108_fu_851_p3;
wire   [0:0] xor_ln108_2_fu_885_p2;
wire   [0:0] tmp_1_fu_741_p3;
wire   [0:0] or_ln108_fu_891_p2;
wire   [0:0] xor_ln108_3_fu_897_p2;
wire   [0:0] select_ln108_1_fu_871_p3;
wire   [0:0] and_ln108_2_fu_879_p2;
wire   [0:0] and_ln108_4_fu_909_p2;
wire   [0:0] or_ln108_2_fu_915_p2;
wire   [0:0] xor_ln108_4_fu_921_p2;
wire   [0:0] and_ln108_3_fu_903_p2;
wire   [0:0] and_ln108_5_fu_927_p2;
wire   [0:0] or_ln108_1_fu_941_p2;
wire   [23:0] select_ln108_2_fu_933_p3;
reg    grp_fu_721_ce;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln92_fu_460_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        tmp_reg_1061 <= select_ln92_fu_490_p3[32'd6];
...
always @ (*) begin
    if (((icmp_ln105_reg_1107_pp0_iter5_reg == 1'd0) & (ap_enable_reg_pp0_iter6 == 1'b1) & (1'b0 == ap_block_pp0_stage0_grp1))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln92_fu_460_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    if (((icmp_ln105_reg_1107_pp0_iter5_reg == 1'd0) & (ap_enable_reg_pp0_iter6 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001_grp1))) begin
...
assign add_ln101_fu_548_p2 = (tmp_s_fu_510_p3 + zext_ln101_fu_544_p1);

assign add_ln108_fu_779_p2 = (trunc_ln4_fu_749_p4 + zext_ln108_fu_775_p1);

assign add_ln92_1_fu_466_p2 = (ap_sig_allocacmp_indvar_flatten15_load + 15'd1);

assign add_ln92_fu_478_p2 = (ap_sig_allocacmp_i_load + 9'd1);

assign add_ln95_fu_580_p2 = (select_ln92_fu_490_p3 + 7'd1);

assign and_ln108_1_fu_865_p2 = (xor_ln108_1_fu_859_p2 & icmp_ln108_fu_823_p2);

assign and_ln108_2_fu_879_p2 = (icmp_ln108_1_fu_839_p2 & and_ln108_fu_799_p2);

assign and_ln108_3_fu_903_p2 = (xor_ln108_3_fu_897_p2 & or_ln108_fu_891_p2);

assign and_ln108_4_fu_909_p2 = (tmp_4_fu_785_p3 & select_ln108_1_fu_871_p3);

assign and_ln108_5_fu_927_p2 = (xor_ln108_4_fu_921_p2 & tmp_1_fu_741_p3);

assign and_ln108_fu_799_p2 = (xor_ln108_fu_793_p2 & tmp_3_fu_767_p3);
...
always @ (*) begin
    ap_block_state7_io_grp1 = ((icmp_ln105_reg_1107_pp0_iter5_reg == 1'd0) & (m_axi_C_0_WREADY == 1'b0));
end
...
assign icmp_ln105_fu_574_p2 = ((select_ln92_fu_490_p3 == 7'd0) ? 1'b1 : 1'b0);

assign icmp_ln108_1_fu_839_p2 = ((tmp_7_fu_829_p4 == 3'd7) ? 1'b1 : 1'b0);

assign icmp_ln108_2_fu_845_p2 = ((tmp_7_fu_829_p4 == 3'd0) ? 1'b1 : 1'b0);

assign icmp_ln108_fu_823_p2 = ((tmp_6_fu_813_p4 == 2'd3) ? 1'b1 : 1'b0);

assign icmp_ln92_fu_460_p2 = ((ap_sig_allocacmp_indvar_flatten15_load == 15'd16640) ? 1'b1 : 1'b0);

assign icmp_ln95_fu_484_p2 = ((ap_sig_allocacmp_j_load == 7'd65) ? 1'b1 : 1'b0);

assign lshr_ln3_fu_522_p4 = {{select_ln92_fu_490_p3[6:3]}};
...
assign m_axi_C_0_WDATA = select_ln108_3_reg_1121;
...
assign or_ln108_1_fu_941_p2 = (and_ln108_5_fu_927_p2 | and_ln108_3_fu_903_p2);

assign or_ln108_2_fu_915_p2 = (and_ln108_4_fu_909_p2 | and_ln108_2_fu_879_p2);

assign or_ln108_fu_891_p2 = (xor_ln108_2_fu_885_p2 | tmp_4_fu_785_p3);

assign s_cur_1_fu_706_p3 = ((tmp_reg_1061[0:0] == 1'b1) ? 17'd0 : s_cur_fu_660_p19);

assign s_cur_fu_660_p17 = 'bx;

assign select_ln108_1_fu_871_p3 = ((and_ln108_fu_799_p2[0:0] == 1'b1) ? and_ln108_1_fu_865_p2 : icmp_ln108_1_fu_839_p2);

assign select_ln108_2_fu_933_p3 = ((and_ln108_3_fu_903_p2[0:0] == 1'b1) ? 24'd8388607 : 24'd8388608);

assign select_ln108_3_fu_947_p3 = ((or_ln108_1_fu_941_p2[0:0] == 1'b1) ? select_ln108_2_fu_933_p3 : add_ln108_fu_779_p2);

assign select_ln108_fu_851_p3 = ((and_ln108_fu_799_p2[0:0] == 1'b1) ? icmp_ln108_1_fu_839_p2 : icmp_ln108_2_fu_845_p2);

assign select_ln92_1_fu_607_p3 = ((icmp_ln95_reg_1009[0:0] == 1'b1) ? 17'd0 : empty_28_fu_190);

assign select_ln92_2_fu_614_p3 = ((icmp_ln95_reg_1009[0:0] == 1'b1) ? 24'd0 : empty_fu_186);

assign select_ln92_3_fu_498_p3 = ((icmp_ln95_fu_484_p2[0:0] == 1'b1) ? add_ln92_fu_478_p2 : ap_sig_allocacmp_i_load);

assign select_ln92_fu_490_p3 = ((icmp_ln95_fu_484_p2[0:0] == 1'b1) ? 7'd0 : ap_sig_allocacmp_j_load);

assign sext_ln107_fu_737_p1 = grp_fu_721_p2;

assign t_cur_1_fu_699_p3 = ((tmp_reg_1061[0:0] == 1'b1) ? 24'd0 : t_cur_fu_621_p19);

assign t_cur_fu_621_p17 = 'bx;

assign tmp_1_fu_741_p3 = sext_ln107_fu_737_p1[32'd47];

assign tmp_2_fu_759_p3 = sext_ln107_fu_737_p1[32'd13];

assign tmp_3_fu_767_p3 = sext_ln107_fu_737_p1[32'd37];

assign tmp_4_fu_785_p3 = add_ln108_fu_779_p2[32'd23];

assign tmp_5_fu_805_p3 = sext_ln107_fu_737_p1[32'd38];

assign tmp_6_fu_813_p4 = {{grp_fu_721_p2[40:39]}};

assign tmp_7_fu_829_p4 = {{grp_fu_721_p2[40:38]}};

assign tmp_s_fu_510_p3 = {{trunc_ln101_fu_506_p1}, {3'd0}};

assign top_kernel_ap_fixed_64_ap_fixed_24_10_0_0_0_64_scale_mem_1_address0 = zext_ln95_fu_532_p1;
...
assign top_kernel_ap_fixed_64_ap_fixed_24_10_0_0_0_64_scale_mem_2_address0 = zext_ln95_fu_532_p1;
...
assign top_kernel_ap_fixed_64_ap_fixed_24_10_0_0_0_64_scale_mem_3_address0 = zext_ln95_fu_532_p1;
...
assign top_kernel_ap_fixed_64_ap_fixed_24_10_0_0_0_64_scale_mem_4_address0 = zext_ln95_fu_532_p1;
...
assign top_kernel_ap_fixed_64_ap_fixed_24_10_0_0_0_64_scale_mem_5_address0 = zext_ln95_fu_532_p1;
...
assign top_kernel_ap_fixed_64_ap_fixed_24_10_0_0_0_64_scale_mem_6_address0 = zext_ln95_fu_532_p1;
...
assign top_kernel_ap_fixed_64_ap_fixed_24_10_0_0_0_64_scale_mem_7_address0 = zext_ln95_fu_532_p1;
...
assign top_kernel_ap_fixed_64_ap_fixed_24_10_0_0_0_64_scale_mem_address0 = zext_ln95_fu_532_p1;
...
assign top_kernel_ap_fixed_64_ap_fixed_24_10_0_0_0_64_tmp_1_address0 = zext_ln101_1_fu_554_p1;
...
assign top_kernel_ap_fixed_64_ap_fixed_24_10_0_0_0_64_tmp_2_address0 = zext_ln101_1_fu_554_p1;
...
assign top_kernel_ap_fixed_64_ap_fixed_24_10_0_0_0_64_tmp_3_address0 = zext_ln101_1_fu_554_p1;
...
assign top_kernel_ap_fixed_64_ap_fixed_24_10_0_0_0_64_tmp_4_address0 = zext_ln101_1_fu_554_p1;
...
assign top_kernel_ap_fixed_64_ap_fixed_24_10_0_0_0_64_tmp_5_address0 = zext_ln101_1_fu_554_p1;
...
assign top_kernel_ap_fixed_64_ap_fixed_24_10_0_0_0_64_tmp_6_address0 = zext_ln101_1_fu_554_p1;
...
assign top_kernel_ap_fixed_64_ap_fixed_24_10_0_0_0_64_tmp_7_address0 = zext_ln101_1_fu_554_p1;
...
assign top_kernel_ap_fixed_64_ap_fixed_24_10_0_0_0_64_tmp_address0 = zext_ln101_1_fu_554_p1;
...
assign trunc_ln101_fu_506_p1 = select_ln92_3_fu_498_p3[7:0];

assign trunc_ln4_fu_749_p4 = {{grp_fu_721_p2[37:14]}};

assign trunc_ln95_fu_518_p1 = select_ln92_fu_490_p3[2:0];

assign xor_ln108_1_fu_859_p2 = (tmp_5_fu_805_p3 ^ 1'd1);

assign xor_ln108_2_fu_885_p2 = (select_ln108_fu_851_p3 ^ 1'd1);

assign xor_ln108_3_fu_897_p2 = (tmp_1_fu_741_p3 ^ 1'd1);

assign xor_ln108_4_fu_921_p2 = (or_ln108_2_fu_915_p2 ^ 1'd1);

assign xor_ln108_fu_793_p2 = (tmp_4_fu_785_p3 ^ 1'd1);

assign zext_ln101_1_fu_554_p1 = add_ln101_fu_548_p2;

assign zext_ln101_fu_544_p1 = lshr_ln3_fu_522_p4;

assign zext_ln108_fu_775_p1 = tmp_2_fu_759_p3;

assign zext_ln95_fu_532_p1 = lshr_ln3_fu_522_p4;

endmodule //top_kernel_top_kernel_Pipeline_VITIS_LOOP_92_10_VITIS_LOOP_95_11
